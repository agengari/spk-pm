      ...
      <div class="container" style="padding-top: 5rem">
        <div class="row">
          <div class="col text-center">
            <h2>Daftar Bobot Hasil Gap</h2>
            <p>Selisih yang telah didapatkan seperti pada tabel gap sebelumnya, kemudian dilakukan pembobotan berdasarkan tabel Skala Pembobotan yang terdapat di halaman awal.</p>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card mt-3 mb-2">
              <div class="card-header text-white" style="background-color: #c03369">Pembobotan Hasil Nilai Gap Yang Didapat</div>
              <div class="card-body">
                ...
                <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo number_format($bobotnatrium, 1); ?></td>
                        <td><?php echo number_format($bobotlemak, 1); ?></td>
                        <td><?php echo number_format($bobotprotein, 1); ?></td>
                      </tr>
