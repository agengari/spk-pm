    ...
    <section id="hasil" style="background-color: #f3f4f5; padding-top: 5rem">
      <div class="container text-center">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <p>
              Berikut ni adalah peringkat makanan dari 3 alternatif yang telah anda pilih, silahkan gunakan sebagai pertimbangan dalam menentukan pilihan makanan dengan bijak!
            </p>
          </div>
        </div>
        <div class="row justify-content-center">
