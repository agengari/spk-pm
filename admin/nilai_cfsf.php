      ...
      <div class="container" style="padding-top: 5rem">
        <div class="row">
          <div class="col text-center">
            <h2>Daftar Nilai CF & SF</h2>
            <p>Nilai Core Factor (CF) didapatkan dari nilai Natrium dan Lemak dijumlahkan dan dibagi 2, sedangkan nilai Secondary Factor didapatkan dari nilai Protein.</p>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-10">
            <div class="card mt-3 mb-2">
              <div class="card-header text-white" style="background-color: #c03369">Hasil Perhitungan Core Factor dan Secondary Factor</div>
              <div class="card-body">
