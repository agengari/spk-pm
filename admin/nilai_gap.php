  ...
  <body id="home">
    ...
    <section style="background-color: #f3f4f5">
      <div class="container" style="padding-top: 5rem">
        <div class="row">
          <div class="col">
            <h2 class="text-center">Daftar Nilai Gap</h2>
            <p class="text-center">Nilai hasil Konversi yang telah didapat, selanjutnya dikurangkan dengan nilai Profil Makanan, Yaitu :
              <ul>
                <li>Natrium : 3</li>
                <li>Lemak : 3</li>
                <li>Protein : 1</li>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card mt-3 mb-2">
              <div class="card-header text-white" style="background-color: #c03369">Perhitungan Gap Data Makanan Dengan Profile Makanan</div>
              <div class="card-body">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php echo number_format($gapnatrium); ?></td>
                              <td><?php echo number_format($gaplemak); ?></td>
                              <td><?php echo number_format($gapprotein); ?></td>
                            </tr>
