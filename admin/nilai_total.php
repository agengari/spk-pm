      ...
      <div class="container" style="padding-top: 5rem">
        <div class="row">
          <div class="col text-center">
            <h2>Nilai Total</h2>
            <p>Nilai Total didapatkan dari Nilai CF dikalikan 80% ditambah dengan Nilai SF dikalikan 20%.</p>  
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card mt-3 mb-2">
              <div class="card-header text-white" style="background-color: #c03369">Perhitungan Nilai Total dengan CF 80% dan SF 20%</div>
              <div class="card-body">
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <?php
                     ...
                     if ($_GET[proses] == "simpan") {
                        mysql_query("insert into hasil values('0','$data[id_makanan]','$cf','$sf','$nt')");
                     }
                     ?>
                     <tr>
                        <td><?php echo $no++;  ?></td>
              ...
              <div style="margin:5px;">
                <a href="nilai_total.php?proses=simpan" class="btn btn-info">Proses Hasil</a>
              </div>
              <?php
                      if ($_GET[proses] == "simpan") {
                          echo "<script type='text/javascript'>
                                  alert('Data Tersimpan..!!');
                                  document.location='hasil_akhir.php'
                        </script>";
